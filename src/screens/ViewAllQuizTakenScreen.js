...
const ViewAllQuizTakenScreen = props => {
    ...
    useEffect(() => {
        if (!dataLoaded)
            firebaseWrapper.ViewAllQuizTaken(setData, setDataLoaded);
    ...
    return (
        <View style={styles.screen}>
            <Text style={{ margin: 15, fontSize: 22, fontWeight: 'bold', marginBottom: 30 }}>Select A Quiz to view its attendance</Text>
...
export default ViewAllQuizTakenScreen;